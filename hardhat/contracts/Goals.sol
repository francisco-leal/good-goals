...
contract Goals {
    ...
    function joinGroup(string calldata _groupName, string calldata _goalTitle, string calldata _goalDescription, uint256 _amount) onlyValidGroup(_groupName) public {
